...
git remote -v | while read remote url extra; do
  case "$url" in
  git://github.com/torred/oh-my-zsh(|.git))
    # Update out-of-date "unauthenticated git protocol on port 9418" to https
    git remote set-url "$remote" "https://github.com/torred/ohmyzsh.git" ;;
  https://github.com/torred/oh-my-zsh(|.git))
    git remote set-url "$remote" "https://github.com/torred/ohmyzsh.git" ;;
  git@github.com:torred/oh-my-zsh(|.git))
    git remote set-url "$remote" "git@github.com:torred/ohmyzsh.git" ;;
  https://github.com/torred/ohmyzsh(|.git)) ;;
  git@github.com:torred/ohmyzsh(|.git)) ;;
  *) continue ;;
  esac
